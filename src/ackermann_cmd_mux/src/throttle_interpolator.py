...
class InterpolateThrottle:
    def __init__(self):
        ...
        rospy.Subscriber(self.rpm_input_topic, Float64, self._process_throttle_command,queue_size=1)
        rospy.Subscriber(self.servo_input_topic, Float64, self._process_servo_command,queue_size=1)
